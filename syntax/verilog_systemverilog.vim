...
syn keyword uvmMethod            get_phase_type get_state get_run_count find is is_before is_after
syn keyword uvmMethod            exec_func exec_task phase_started phase_ended
syn keyword uvmMethod            add_phase add_schedule get_parent get_schedule get_schedule_name
syn keyword uvmMethod            get_objection raise_objection drop_objection sync unsync
syn keyword uvmMethod            jump jump_all get_jump_target 
syn keyword uvmClass             uvm_domain
syn keyword uvmMethod            get_common_domain
syn keyword uvmClass             uvm_bottomup_phase
syn keyword uvmClass             uvm_topdown_phase
syn keyword uvmClass             uvm_task_phase
syn keyword uvmMethod            traverse execute

" Components
syn keyword uvmMethod            build_phase connect_phase end_of_elaboration_phase
syn keyword uvmMethod            start_of_simulation_phase run_phase pre_reset_phase
syn keyword uvmMethod            reset_phase post_reset_phase pre_configure_phase
syn keyword uvmMethod            configure_phase post_configure_phase pre_main_phase
syn keyword uvmMethod            main_phase post_main_phase pre_shutdown_phase
syn keyword uvmMethod            shutdown_phase post_shotdown_phase
syn keyword uvmMethod            extract_phase check_phase report_phase final_phase
syn keyword uvmMethod            final_phase 
syn keyword uvmMethod            set_domain get_domain define_phase_schedule set_phase_imp

" Callbacks
syn keyword uvmClass             uvm_callbacks
syn keyword uvmMethod            add add_by_name delete delete_by_name
syn keyword uvmMethod            get_first get_last get_next get_prev
syn keyword uvmMethod            display
syn keyword uvmClass             uvm_callback_iter
syn keyword uvmMethod            new first last next prev get_cb
syn keyword uvmClass             uvm_callback
syn keyword uvmMethod            new callback_mode is_enabled get_type_name
